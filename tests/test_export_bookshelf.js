...
for (const suffix of ["", "v0/", "v1/", "v123/"]) {
...
(async () => {
    ...
    try {
        ...
        global.performance = { getEntriesByType: () => [
            ...
            { name: "https://fanqienovel.com/reading/bookapi/bookshelf/info/v0/?from=page" },
        ...
        assert.strictEqual(new URL(requests[0].url).pathname, "/reading/bookapi/bookshelf/info/v0/");
