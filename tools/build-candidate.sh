...
for document in bookshelf-format.md BROWSER_EXPORT_PILOT_2026-09-08.md compatibility-matrix.md COMPATIBILITY_PILOT_2026-09-03.md EPHEMERAL_HTTP_AUDIT.md QR_THREAT_MODEL.md QUALITY_PLAN.md SUBPROCESS_SECURITY_AUDIT.md TLS_SECURITY_AUDIT.md; do
